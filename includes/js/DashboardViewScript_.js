    ...
    success: function (result) {
      switch (result.Status) {
        ...
        case "0":
          ...
          var getInboxButtonArray = [
            "deletebttn btn-light",
            "trash-inbox",
            "",
            "onDeleteAnchorClicked(this);",
            "Trash",
          ];
          for (var i = 0; i < result.Emails.length; i++) {
            ...
            var rowHtml =
              ...
              "</td>";
            addRow(generateRowHtml(i, mail, getInboxButtonArray), "mailTable");
          }
        ...
        case "0":
          ...
          for (var i = 0; i < result.Emails.length; i++) {
            ...
            var rowHtml =
              ...
              "</td>";
            addRow(generateRowHtml(i, mail, getDraftButtonArray), "mailTable");
          }
        ...
        case "0":
          ...
          for (var i = 0; i < result.Emails.length; i++) {
            ...
            var rowHtml =
              ...
              "</td>";
            addRow(generateRowHtml(i, mail, getTrashButtonArray), "mailTable");
          }
    ...
    success: function (result) {
      switch (result.Status) {
        ...
        case "0":
          ...
          for (var i = 0; i < result.Emails.length; i++) {
            var mail = result.Emails[i];
            addRow(generateRowHtml(i, mail, sendMailButtonArray), "mailTable");
          }
...
function generateRowHtml(indexer, mail, buttonArray) {
  if (mail == null) {
    setTimeout(function () {
      Swal.fire({
        title: "Failed!",
