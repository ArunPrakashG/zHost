...
<head>
    ...
    <script src="../includes/js/SendView.js"></script>
        ...
        <div class="sidebar-menu sticky-sidebar-menu">
            ...
            <div class="sidebar-menu-inner">
                <ul class="nav nav-pills nav-stacked custom-nav" id="navItems">
                    ...
                    <li class="active"><a href="../Views/SendView.php"><span> Send</span></a></li>
                    <li class=""><a href="../Views/TrashView.php"><span> Trash</span></a></li>
                </ul>
            </div>
        </div>
                            ...
                            <ul>
                                <li class="dropdown profile_details_drop">
                                    ...
                                    <ul class="dropdown-menu drp-mnu" aria-labelledby="dropdownMenu3">
                                        ...
                                        <li> <a href="../Views/ProfileView.php"><i class="lnr lnr-user"></i>My Profile</a> </li>
